...
public class ModelDTO {
		...
		public void money_Manage() {  // 수익률 관리 함수
		...
		public void randGame() { // 로또 게임 생성기
		...
		public void passivity_view() {	//수동 뷰
			
			
			
			for (int i = 0; i < this.passivity; i++) {
				
				Arrays.sort(this.number[i]);
